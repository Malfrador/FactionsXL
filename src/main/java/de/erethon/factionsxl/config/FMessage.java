...
public enum FMessage implements Message {
    ...
    CMD_REQUESTS_TITLE("cmd.requests.title", "&2&lOpen requests"),
    ...
    HELP_REQUESTS("help.requests", "/f requests - Shows your current requests"),
    ...
    RELATION_DENIED("relation.denied", "&aThe faction &v1 &adenied the request to set the relation with &v2&a to &v3&a."),
    ...
    RELATION_REQUEST_BUTTON("relation.requestButton", "&v1 &a=> &v2: Change relation to &v3"),
    RELATION_REQUEST_VASSAL("relatiob,requestVassal", "&4Accepting will make &v1 &4a vassal."),
