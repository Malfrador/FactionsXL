...
/**
 * This event gets fired when the truce of a war ends
 */
public class WarTruceEndEvent extends Event implements Cancellable {
    ...
    public WarTruceEndEvent(WarParty a, WarParty d, CasusBelli cb) {
        attacker = a;
        defender = d;
        casusBelli = cb;
    }
