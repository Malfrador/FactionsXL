...
public enum FMessage implements Messages {
    ...
    HELP_CMD_NEUTRAL("help.cmd.neutral", "/f neutral ([faction]) [target] - Changes the relation with a faction to neutral."),
    HELP_CMD_OATH("help.cmd.oath", "/f oath ([faction]) [target] - Offers an oath of fealty to the faction sothat you become its vassal."),
